const TermsConditions = () => {
	return (
		<div className="flex justify-center items-center p-10 bg-text_blue text-white">
			<main className="w-11/12 flex flex-col gap-5">
				<h1 className="text-4xl font-bold">Terms & Conditions</h1>
				<section className="flex flex-col gap-2">
					<h2 className="text-2xl font-bold">Terms & Conditions</h2>
					<p>
						These terms and conditions applies to the Wellness app (hereby
						referred to as "Application") for mobile devices that was created by
						Wellness (hereby referred to as "Service Provider") as a Free
						service.
					</p>
					<p>
				...
				<section className="flex flex-col gap-2">
					...
					<p>These terms and conditions are effective as of 2024-04-18</p>
				</section>
				<section className="flex flex-col gap-2">
